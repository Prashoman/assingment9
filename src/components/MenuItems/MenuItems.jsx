        ...
        <div>
            <div className='bg-blue-50 md:flex md:justify-between px-5 md:px-28 items-center'>
                <div className=' md:w-80'>
                    ...
                    <h1 className='text-2xl md:text-4xl'>One Step Closer To Your <span className='font-extrabold text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>Dream Job</span> </h1>

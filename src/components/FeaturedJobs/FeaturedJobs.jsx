...
const FeaturedJobs = () => {
    ...
    return (
        <div className='mt-8 mb-10 p-3'>
            ...
            <div className='grid md:grid-cols-2 gap-5 md:px-28'>
                {
            ...
            </div>
            {
                show || <div className='text-center'>
                    ...
                    <button onClick={handleSliceAll} className='bg-blue-800  text-white rounded border px-3 py-2 mt-7'>See All Jobs</button>
                </div>
            }
